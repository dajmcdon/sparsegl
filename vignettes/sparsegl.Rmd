...
* `loss`: A character string specifying the loss function to use, could be either
linear regression loss "ls" or logistic regression loss "ls". Default is "ls".
...
```{r}
fit1 <- sparsegl(X, y, group = groups, loss = "ls")
```
...
```{r}
fit_l1 <- cv.sparsegl(X, y, group = groups, loss = "ls", pred.loss = "L1")
```
