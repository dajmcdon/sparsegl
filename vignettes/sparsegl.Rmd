...
If `group` is set with FALSE by default, a list of 2 plots will be generated from this 
function. 
...
If `group` is set with TRUE, a list of 4 plots will be generated from this function.
Notice that the number of curves appearing on the plots could be less than the actual 
...
is `lambda.1se`.
```{r}
coef_l1 <- coef(fit_l1, s = "lambda.min")
...
```{r}
pred_l1 <- predict(fit_l1, newx = X[20:50, ], s = "lambda.min")
