...
The main focus of this package is for the case where the loglikelihood is corresponds to Gaussian of logistic regression. But we also provide the ability to fit arbitrary GLMs using `stats::family()` objects.
