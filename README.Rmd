...
---
 ...
 <!-- badges: start -->
  [![R-CMD-check](https://github.com/dajmcdon/sparsegl/workflows/R-CMD-check/badge.svg)](https://github.com/dajmcdon/sparsegl/actions)[![CRAN status](https://www.r-pkg.org/badges/version/sparsegl)](https://CRAN.R-project.org/package=sparsegl)
  <!-- badges: end -->
...
penalized learning problems. The model is typically fit for a sequence of 
regularization parameters $\lambda$. Such estimators minimize
...
corresponds to Gaussian or logistic regression. But we also provide the ability
to fit arbitrary GLMs using `stats::family()` objects. Details may be found in
...
```{r minimal-ex, echo = TRUE, fig.align = 'center', dev="svg"}
set.seed(1010)
n <- 100
p <- 200
