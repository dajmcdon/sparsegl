...
#' cross-validated [sparsegl()] model, using the stored \code{"sparsegl.fit"}
...
#'
#' This function makes predictions from a cross-validated [sparsegl()] model,
...
#' on to the [predict()] method for [sparsegl()] objects.
