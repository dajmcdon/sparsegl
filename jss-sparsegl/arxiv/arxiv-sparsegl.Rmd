...
output: 
  pdf_document:
    ...
    includes:
      in_header: arxiv-sparsegl-preamble.tex
linkcolor: DarkBlue
citecolor: DarkBlue
urlcolor: Crimson
---
...
knitr::opts_chunk$set(echo = TRUE, cache = TRUE, fig.path = "fig/", fig.align = "center", fig.pos = "t!")
...
In addition to the \proglang{R} packages described above, this manuscript and \pkg{sparsegl} benefitted from \pkg{devtools} \citep{R-devtools}, \pkg{usethis} \citep{R-usethis}, \pkg{testthat} \citep{R-testthat}, \pkg{knitr} \citep{R-knitr}, \pkg{ggplot2} \citep{R-ggplot2}, and \pkg{rticles} \citep{R-rticles}. 
...
\bibliography{pkgs.bib, sparsegl.bib}
