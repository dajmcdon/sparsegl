...
```{r, simulation log,eval = FALSE, include = FALSE}
...
```{r, concat, eval = FALSE, include = FALSE}
df1 <- bind_rows(within_p, within_n, without_p, without_n)
df2 <- bind_rows(log_within_p, log_within_n, log_without_p, log_without_n)
```

```{r, eval = FALSE, include = FALSE, echo = FALSE, fig.cap = "Running Time Comparison", fit.width = 5, fig.height = 5}
