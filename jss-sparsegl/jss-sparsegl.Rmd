...
The neurological model predicts the DWI signal using the tractogram, apportioning the image signal at each voxel to the streamlines according to the observed gradient field. This preprocessing is shown pictorially \autoref{fig:dwi-model-description}.
