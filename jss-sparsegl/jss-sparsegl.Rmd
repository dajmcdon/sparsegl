...
The model performs DWI signal prediction by using the tractogram as predictors, simulating for each streamline what would be its signal given the voxels they are located at and the applied gradient fields.
