...
Estimating the group lasso using \pkg{sparsegl} with 61 groups based on neuroanatomy and 100 values of $\lambda$ took just under 2 minutes on a 2020 MacBook Air (Apple M1 chip) with 16 GB of RAM. \autoref{fig:brains} shows the group norm of the 61 groups against the magnitude of the group penalty.
