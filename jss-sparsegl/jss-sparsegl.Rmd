...
```{r accuracy, echo=FALSE, warning=FALSE, message=FALSE, eval=TRUE, fig.cap="This figure shows \\% change in objective function for \\pkg{gglasso} and \\pkg{CVXR} relative to \\pkg{sparsegl}. The x-axis is scaled to make the $\\lambda$ range comparable across conditions.", fig.height=4, fig.width=6}
...
Inspecting the estimated $\widehat{\beta}$,
